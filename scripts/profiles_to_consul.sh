...
# Stores the User service’s Spring Profiles in Consul’s hierarchical key/value store
...
KEY="config/user-service,docker-local/data"
...
KEY="config/user-service,docker-production/data"
